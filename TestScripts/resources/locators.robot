...
Library                 QWeb
*** Variables ***
&{QentinelXpath}             CartValue=xpath=//span[text()="$9.00"]    GreenBg==xpath=//div[@style="background-color: #67aa79"]    Greenimg==xpath=/html/body/div[2]/section/div/div/div[1]/div[2]/a/img     CreamBG==xpath=//div[@style="background-color: #dfd3c2"]    CreamImg==xpath=/html/body/div[2]/section/div/div/div[1]/div[1]/a    
